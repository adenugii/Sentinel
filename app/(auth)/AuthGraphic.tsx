...
import { ShieldCheck, CheckCircle, Wifi, Box } from "lucide-react";
                ...
                <div className="pt-5 border-t border-white/10 flex justify-between items-center">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            ...
                            {/* UPDATE: Menggunakan Sepolia Testnet (Etherscan) */}
                            <span className="text-sm font-medium text-green-400">Sepolia Testnet</span>
                        </div>
                    </div>
                    <div className="text-right">
                        <span className="text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Verified On</span>
                        <div className="flex items-center justify-end gap-1 mt-1 opacity-90 group-hover:opacity-100 transition-opacity">
                            <Box className="w-3 h-3 text-gray-300" />
                            <p className="text-sm font-mono text-white tracking-wide">Etherscan</p>
                        </div>
                    </div>
                </div>
            </div>
